        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group mt-3">
                        ...
                        <datalist id="sugerencia">
                            <option
                                value="HOJA DE TRAMITE RECTORADO N° 0001/{{ substr($fecha_actual, 0, 4) }} Y NOTA INTERNA CITE: UPEA-CS Nª0001/{{ substr($fecha_actual, 0, 4) }}">
                        </datalist>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-danger btn-submit" data-estado="rechazado">
                        Rechazar formulario
                    </button>
                    <button type="button" class="btn btn-warning btn-submit" data-estado="aprobado">
                        Aprobar formulario
                    </button>
                    <button type="button" class="btn btn-success btn-submit" data-estado="ejecutado">
