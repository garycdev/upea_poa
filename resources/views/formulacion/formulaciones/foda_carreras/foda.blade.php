        ...
        <div class="tabs-wrap">
            <nav class="tabs-button">
                <div class="nav nav-tabs" role="tablist">
                    <button class="nav-link active" data-bs-toggle="tab" data-bs-target="#fortaleza_c" type="button" role="tab" aria-selected="true">
                        FORTALEZAS
                    </button>

                    <button class="nav-link" data-bs-toggle="tab" data-bs-target="#oportunidades_c" type="button" role="tab" aria-selected="false">
                        OPORTUNIDADES
                    </button>

                    <button class="nav-link" data-bs-toggle="tab" data-bs-target="#debilidad_c" type="button" role="tab" aria-selected="false">
                        DEBILIDADES
                    </button>

                    <button class="nav-link" data-bs-toggle="tab" data-bs-target="#amenaza_c" type="button" role="tab" aria-selected="false">
                        AMENAZAS
                    </button>
                </div>
            </nav>
                            ...
                            <div class="container-fluid">
                                <div class="card-box-style">
                                    <div class="others-title d-flex align-items-center">
                                        <h3>FORTALEZAS</h3>
                                        <div class=" ms-auto position-relative">
                                            <button type="button" class="btn btn-outline-primary" onclick="abrir_modal()"> <i class="bx bxs-add-to-queue"></i> Nueva Foda</button>
                                        </div>
                                    </div>
        ...
        <div class="modal-dialog modal-lg modal-dialog-scrollable">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"  onclick="cerrar_modal_foda_c()"></button>
                </div>
                    ...
                    <form id="form_foda" method="post" autocomplete="off">
                        ...
                        <div class="row">
                            <div class="mb-3">
                                ...
                                <select name="tipo_foda" id="tipo_foda" class="form-select form-control" onchange="seleccionar_foda_c(this.value)">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-outline-danger btn-sm" data-bs-dismiss="modal" onclick="cerrar_modal_foda_c()">Cerrar</button>
                    <button type="button" class="btn btn-outline-primary btn-sm" id="btn_guardar_fodaC"> <i class="bx bxs-save" id="icono_rodry"></i> Guardar FODA</button>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-outline-primary btn-sm" id="btn_guardar_foda_editadoC"> <i class="bx bxs-save" id="icono_rodry"></i> Guardar FODA</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        function listar_fortaleza_c(){
            $.ajax({
                ...
                data: {id_gestiones:id_gestiones, tipo_foda:1},
                dataType: "JSON",
                success: function (data) {
                    let i=1;
        ...
        function listar_oportunidad_c(){
            $.ajax({
                type: "POST",
                url: "{{ route('fodac_listarFoda') }}",
                data: {id_gestiones:id_gestiones, tipo_foda:2},
                dataType: "JSON",
                success: function (data) {
                    let i=1;
        ...
        function listar_debilidad_c(){
            $.ajax({
                type: "POST",
                url: "{{ route('fodac_listarFoda') }}",
                data: {id_gestiones:id_gestiones, tipo_foda:3},
                dataType: "JSON",
                success: function (data) {
                    let i=1;
        ...
        function listar_amenaza_c(){
            $.ajax({
                type: "POST",
                url: "{{ route('fodac_listarFoda') }}",
                data: {id_gestiones:id_gestiones, tipo_foda:4},
                dataType: "JSON",
                success: function (data) {
                    let i=1;
