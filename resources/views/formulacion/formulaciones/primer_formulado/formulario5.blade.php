...
@section('contenido')
            ...
            <div class="card-box-style">
                <div class="others-title d-flex align-items-center">
                    ...
                    <div class=" ms-auto position-relative">
                        <button type="button" class="btn btn-outline-primary" data-bs-toggle="modal" data-bs-target="#nuevo_formulario5"  ><i class="bx bxs-add-to-queue"></i> Nuevo registro</button>
                    </div>
                </div>
                ...
                <div class="row d-flex justify-content-center align-items-center" >
                    ...
                    <div class="col-sm-12 col-md-12 col-lg-6 col-lg-6">
                        <div class="alert alert-success" role="alert">
                            ...
                            <p> <strong>{{ '['.$formulario2_detalle->indicador->codigo.'] : ' }}</strong> {{ $formulario2_detalle->indicador->descripcion }} </p>
                        </div>
                    </div>
                    <div class="col-sm-12 col-md-12 col-lg-6 col-lg-6">
                        <div class="alert alert-danger" role="alert">
                            ...
                            @foreach ($formulario4->asignacion_monto_f4 as $lis)
                                ...
                                @endphp
                                <ul>
                                    <li> <strong> {{ con_separador_comas($lis->monto_asignado).' Bs ' }} </strong>  {{ ' [ '.$lis->financiamiento_tipo->sigla.' ] '.'['.$lis->financiamiento_tipo->descripcion.']' }} </li>
                                </ul>
                            @endforeach
                    ...
                    <table class="table table-responsive  text-center table-bordered table-hover" style="width:100%; font-size: 10px;" >
                        ...
                        <tbody>
                            ...
                            @foreach ($formulario4->formulario5_f4 as $lis)
                                <tr>
                                    <td>
                                        <button class="btn btn-outline-warning btn-sm" onclick="editar_formulario5('{{ $lis->id }}')"><i class="ri-edit-2-fill"></i></button>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <button class="btn btn-outline-primary" onclick="asignar_requerimientos('{{ $lis->id }}')">Agregar</button>
                                    </td>
                                    <td>
                                        <a href="{{ route('req_listar', ['id' => encriptar($lis->id)]) }}" class="btn btn-outline-primary" >Listar</a>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
    ...
    <div class="modal slide" id="nuevo_formulario5" data-bs-backdrop="static" data-bs-keyboard="false" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog modal-xl  modal-dialog-scrollable">
            <div class="modal-content">
                <div class="modal-header">
                    <h3 class="modal-title fs-5">NUEVO REGISTRO DEL FORMULARIO Nº 5 (Operaciones) </h3>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close" onclick="cerrarModalf5()" ></button>
                </div>
                        ...
                        <fieldset>
                            ...
                            <div class="row">
                                <div class="col-sm-12 col-md-12 col-lg-2 col-xl-2 mb-2"  >
                                    ...
                                    <select name="tipo" id="tipo" class="form-select select2" onchange="seleccionar_describir(this.value)">
                                ...
                                <div class="col-sm-12 col-md-12 col-lg-3 col-xl-3 mb-2"  >
                                    <div class="mb-2">
                                        ...
                                        <select name="operacion" id="operacion" class="form-select select2" @disabled(true)>
                                ...
                                <div class="col-sm-12 col-md-12 col-lg-4 col-xl-4 mb-2"  >
                                    <label for="descripcion_operacion" class="col-form-label">Describa la Operación</label>
                                    <textarea name="descripcion_operacion" id="descripcion_operacion" cols="5" rows="3" class="form-control" @disabled(true)></textarea>
                                    <div id="_descripcion_operacion" ></div>
                                </div>
                                <div class="col-sm-12 col-md-12 col-lg-3 col-xl-3 mb-2"  >
                                    <div class="mb-2">
                                        <label for="tipo_operacion" class="col-form-label">Tipo Operacion</label>
                                        <select name="tipo_operacion" id="tipo_operacion" class="form-select select2" @disabled(true)>
                                            <option selected disabled value="selected">[SELECCIONE TIPO DE OPERACIÓN]</option>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-outline-danger btn-sm" data-bs-dismiss="modal" onclick="cerrarModalf5()" >Cerrar</button>
                    <button type="button" class="btn btn-outline-primary btn-sm" id="btn_guardarF5"> <i class="bx bxs-save" id="icono_rodry" ></i> Guardar</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="modal slide" id="editar_formulario5" data-bs-backdrop="static" data-bs-keyboard="false" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog modal-xl  modal-dialog-scrollable">
            <div class="modal-content">
                <div class="modal-header">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-12 col-md-12 col-lg-4 col-xl-4 mb-2"  >
                                    <div class="mb-2">
                                        ...
                                        <select name="tipo_operacion_" id="tipo_operacion_" class="form-select select2_segundo">
                                            <option selected disabled value="selected">[SELECCIONE TIPO DE OPERACIÓN]</option>
                                            @foreach ($tipo_operacion as $lis)
                                                <option value="{{ $lis->id }}">{{ $lis->nombre }}</option>
                                            @endforeach
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-outline-danger btn-sm" data-bs-dismiss="modal" onclick="cerrarModalf5()" >Cerrar</button>
                    <button type="button" class="btn btn-outline-primary btn-sm" id="btn_guardarF5_editado"> <i class="bx bxs-save" id="icono_rodry" ></i> Guardar</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="modal slide" id="asignar_requerimientosf5" data-bs-backdrop="static" data-bs-keyboard="false" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog modal-xl  modal-dialog-scrollable">
            <div class="modal-content">
                <div class="modal-header">
                    <h3 class="modal-title fs-5">NUEVO REGISTRO DEL FORMULARIO Nº 5 (Requerimientos) </h3>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close" onclick="cerrar_modal_requerimiento()"></button>
                </div>
                <div class="modal-body" >
                    <form id="form_formulario5_operacion" method="POST" autocomplete="off">
                        ...
                        <fieldset>
                            ...
                            <div class="row d-flex justify-content-center align-items-center">
                                <div class="col-sm-12 col-md-12 col-lg-6 col-xl-6 mb-2">
                                    <label for="clasificador_presupuestario" class="col-form-label">Clasificadores Presupuestarios</label>
                                    <select name="clasificador_presupuestario" id="clasificador_presupuestario" class="form-select select2_tercero" onchange="mostrar_clasificador_ver(this.value)">
                                        <option value="selected" selected disabled>[SELECCIONE CLASIFICADOR]</option>
                                        @foreach ($union_tres as $lis)
                                            <option value="{{ $lis->id.'_'.$lis->origen }}">{{ $lis->titulo }}</option>
                                        @endforeach
                                    </select>
                                    <div id="_clasificador_presupuestario" ></div>
                                </div>
                                <div class="col-sm-12 col-md-12 col-lg-6 col-xl-6 mb-2 text-center" id="descripcion_clasificador_html">
                        ...
                        <fieldset>
                            ...
                            <div class="row text-center">
                                <div class="col-sm-12 col-md-12 col-lg-6 col-xl-6 mb-2">
                                    <div class="mb-2">
                                        <label for="tipo_financiamiento_" class="form-label">Tipo de Financiamiento</label>
                                        <select name="tipo_financiamiento_" id="tipo_financiamiento_" class="form-select select2_tercero" onchange="verificar_monto_asignado(this.value)">
                            ...
                            <div class="row text-center">
                                <div class="col-sm-12 col-md-12 col-lg-3 col-xl-3 mb-2">
                                    <div class="mb-2">
                                        ...
                                        <select name="medida" id="medida" class="form-select select2_tercero" onchange="validar_medidaf4(this.value)" @disabled(true)>
                                ...
                                <div class="col-sm-12 col-md-12 col-lg-3 col-xl-3 mb-2">
                                    <div class="mb-2">
                                        ...
                                        <input type="text" class="form-control" id="cantidad" name="cantidad" placeholder="Ingrese la cantidad" maxlength="7" onkeypress="return soloNumeros(event)" @disabled(true)>
                                    </div>
                                </div>
                                <div class="col-sm-12 col-md-12 col-lg-3 col-xl-3 mb-2">
                                    <div class="mb-2">
                                        <label for="precio_unitario" class="form-label">Precio unitario</label>
                                        <input type="text" class="form-control monto_number" id="precio_unitario" name="precio_unitario" placeholder="Ingrese el precio unitario" maxlength="15" onkeyup="validar_monto_precionUnitario(this.value)" @disabled(true)>
                                ...
                                <div class="col-sm-12 col-md-12 col-lg-3 col-xl-3 mb-2">
                                    <div class="mb-2">
                                        ...
                                        <input type="text" class="form-control monto_number" id="total_presupuesto" name="total_presupuesto" onkeyup="validar_monto_asignandoSob(this.value)" placeholder="Total Presupuesto" @disabled(true)>
                                        <div id="_total_presupuesto"></div>
                                    </div>
                                </div>
                                <input type="hidden" class="monto_number" id="total_presupuesto_env" name="total_presupuesto_env">
                                <input type="hidden" class="monto_number" id="monto_sobrante_presupuesto" name="monto_sobrante_presupuesto">
                            </div>
                        </fieldset>
                        <fieldset>
                            ...
                            <div class="row text-center">
                                <div class="col-sm-12 col-md-12 col-lg-6 col-xl-6 mb-2">
                                    <div class="mb-2">
                                        ...
                                        <select name="mes" id="mes" class="form-select select2_tercero" onchange="validar_gestiondia(this.value)">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-outline-danger btn-sm" data-bs-dismiss="modal" onclick="cerrar_modal_requerimiento()" >Cerrar</button>
                    <button type="button" class="btn btn-outline-primary btn-sm" id="btn_guardarRequerimiento"> <i class="bx bxs-save" id="icono_rodry" ></i> Guardar</button>
                </div>
            </div>
        </div>
    </div>
...
@section('scripts')
    <script>
                ...
                success: function (data) {
                    if(data.tipo==='success'){
                        ...
                        asignacion_m.forEach(value => {
                            $('#tipo_financiamiento_').append('<option value = "' + value.id + '">' + '['+value.financiamiento_tipo.sigla+']'+ value.financiamiento_tipo.descripcion +'</option>');
                        });
                        ...
                        $.ajax({
                            ...
                            success: function (res) {
                                document.getElementById('listar_html_requerimientos').innerHTML = res;
                            }
                        });
                    }
                    if(data.tipo==='error'){
                                ...
                                case 3:
                                    valor_html.innerHTML=`
                                        ...
                                        <div class="alert alert-primary alert-dismissible fade show" role="alert">
                                            ...
                                            <hr>
                                            <p>`+data.mensaje.clasificador_tercero.descripcion+`</p>
                                        </div>
                                    `;
                                break;
                                ...
                                case 4:
                                    valor_html.innerHTML=`
                                        ...
                                        <div class="alert alert-primary alert-dismissible fade show" role="alert">
                                            ...
                                            <hr>
                                            <p>`+data.mensaje.clasificador_cuarto.descripcion+`</p>
                                        </div>
                                    `;
                                break;
                                ...
                                case 5:
                                    valor_html.innerHTML=`
                                        ...
                                        <div class="alert alert-primary alert-dismissible fade show" role="alert">
                                            ...
                                            <hr>
                                            <p>`+data.mensaje.clasificador_quinto.descripcion+`</p>
                                        </div>
                                    `;
                                break;
                            }
                    ...
                    success: function (data) {
                        ...
                        switch (unidad_name) {
                            ...
                            case 'MESES':
                                ...
                                input_precio_unitario.value = 'horas trabajadas';
                                input_total_presupuesto.value = '';
                            break;
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        if(data.tipo==='success'){
                            ...
                            document.getElementById('monto_sobrante_presupuesto').value = data.monto_sobrante_comas;
                        }
                        if(data.tipo==='error'){
                            alerta_top(data.tipo, data.mensaje);
                            document.getElementById('total_presupuesto').value = '';
        ...
        function validar_gestiondia(val){
            let input_gestion = document.getElementById('gestion');
            if(val != 'selected'){
                if(val == 1){
