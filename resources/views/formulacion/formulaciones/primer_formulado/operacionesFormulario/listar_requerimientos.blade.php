...
@section('contenido')
                                ...
                                <tr>
                                    <td>
                                        <button class="btn btn-outline-danger btn-sm"
                                            onclick="eliminar_registro_req('{{ $listar_form5->id }}','{{ $lis->id }}')"><i
                                                class="ri-delete-bin-7-fill"></i></button>
                                    </td>
                                    <td>
                                        <button class="btn btn-outline-warning btn-sm"
                                            onclick="editar_registro_req('{{ $listar_form5->id }}','{{ $lis->id }}')"><i
    ...
    {{-- MODAL NUEVO --}}
    <div class="modal slide" id="editar_requerimiento" data-bs-backdrop="static" data-bs-keyboard="false"
            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"
                        onclick="cerrarModal_requerimiento()"></button>
                </div>
                                ...
                                <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4 mb-2">
                                    <div class="mb-2">
                                        <select name="valor" id="valor" class="form-select"
                                            onchange="seleccion_opcion(this.value)">
                                ...
                                <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4 mb-2">
                                    <div class="mb-2">
                                        ...
                                        <input type="text" class="form-control" id="cantidad" name="cantidad"
                                            onkeyup="cantidad_unitario_edit(this.value)" placeholder="Cantidad"
                                ...
                                <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4 mb-2">
                                    <div class="mb-2">
                                        ...
                                        <input type="text" class="form-control monto_number" id="precio_unitario"
                                            name="precio_unitario" onkeyup="precio_unitario_edit(this.value)"
                                            placeholder="Precio unitario" disabled>
                                ...
                                <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4 mb-2">
                                    <div class="mb-2">
                                        ...
                                        <input type="text" class="form-control monto_number" id="total_presupuesto"
                                            name="total_presupuesto" placeholder="Presupuesto total" disabled>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-outline-primary btn-sm" id="btn_guardarF5_reque"
                ...
                success: function(data) {
                    ...
                    if (data.requerimiento.detalle_tercer_clasificador) {
                        if (data.requerimiento.detalle_tercer_clasificador.length > 0) {
                            codigo_clasificador = data.requerimiento.detalle_tercer_clasificador[0]
                                .clasificador_tercero.codigo;
                    ...
                    if (data.requerimiento.detalle_cuarto_clasificador) {
                        if (data.requerimiento.detalle_cuarto_clasificador.length > 0) {
                            codigo_clasificador = data.requerimiento.detalle_cuarto_clasificador[0]
                                .clasificador_cuarto.codigo;
                    ...
                    if (data.requerimiento.detalle_quinto_clasificador) {
                        if (data.requerimiento.detalle_quinto_clasificador.length > 0) {
                            codigo_clasificador = data.requerimiento.detalle_quinto_clasificador[0]
                                .clasificador_quinto.codigo;
                    ...
                    `;
                    document.getElementById('medida').innerHTML = `<strong>` + data.requerimiento.medida
                        .nombre + `</strong>`;
                    document.getElementById('fuente_financiamiento').innerHTML = `<strong>` + data
                        .asignacion_monto_f4.financiamiento_tipo.sigla + `</strong>
                    ...
                    document.getElementById('monto_asignacion_sobrante').innerHTML = `<strong>` + data
                        .monto_asignacion_actual + ` Bs</strong>`;
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        if (data.tipo === 'success') {
                            ...
                            document.getElementById('total_presupuesto_nuevo').value = data
                                .total_presupuesto_n1;

                            //aqui realizamos lo que es de la fuente de financiamiento cuanto tenemos
                            document.getElementById('monto_asignacion_sobrante').innerHTML = `<strong>` + data
                                .nuevo_saldo_n1 + ` Bs</strong>`;
                            btn_para_guardar.disabled = false;
                        ...
                        if (data.tipo === 'error') {
                            ...
                            document.getElementById('monto_asignacion_sobrante').innerHTML = `<strong>` + data
                                .nuevo_saldo_n1 + ` Bs</strong>`;
                            alerta_top('error', 'No puede superar el monto de : ' + data.nuevo_saldo_n1 +
                                ' Bs');
