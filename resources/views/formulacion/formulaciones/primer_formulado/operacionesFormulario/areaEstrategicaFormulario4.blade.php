...
@section('contenido')
                ...
                <div class="others-title d-flex align-items-center">
                    ...
                    <div class=" ms-auto position-relative">
                        <button type="button" class="btn btn-outline-primary" data-bs-toggle="modal"
                            data-bs-target="#nuevo_formulario4"><i class="bx bxs-add-to-queue"></i> Nuevo registro</button>
                    </div>
                </div>
                                ...
                                <tr>
                                    <td class="text-center">
                                        <button class="btn btn-outline-warning btn-sm"
                                            onclick="editarForm4('{{ $lis->id }}')"><i
                                                class="ri-edit-2-fill"></i></button>
                                    </td>
                                    <td>
                                        <a href="{{ route('poa_form5', ['formulario4_id' => encriptar($lis->id), 'formuladoTipo_id' => encriptar($tipo_formulado->id), 'area_estrategica_id' => encriptar($area_estrategica->id)]) }}"
                                            class="btn btn-outline-primary btn-sm">Form #5</a>
                                    </td>
                                    <td>
                                        {{ $lis->codigo }}
                                    </td>
                                    ...
                                    <td>
                                        <button class="btn btn-outline-primary btn-sm"
                                            onclick="asignar_financiadoF4('{{ $lis->id }}')">Asignar GC</button>
                                    </td>
    ...
    {{-- MODAL NUEVO --}}
    <div class="modal slide" id="nuevo_formulario4" data-bs-backdrop="static" data-bs-keyboard="false"
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="form_formulario4" method="POST" autocomplete="off">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12 col-md-12 col-lg-6 col-xl-6 py-2">
                                <fieldset>
                                    ...
                                    <div class="mb-2">
                                        <label for="indicador_formulario2" class="col-form-label">Seleccione Indicador del
                                            formulario nº 2</label>
                                        <select name="indicador_formulario2" id="indicador_formulario2" class="select2"
                                            onchange="validarUnicoform4(this.value)">
                                            <option value="selected" selected disabled>[SELECCIONE INDICADOR DEL FORMULARIO
                                                Nº 2]</option>
                                            @foreach ($formulario2 as $lis)
                                                <option value="{{ $lis->id }} ">[{{ $lis->indicador->codigo }}]
                                                    {{ $lis->indicador->descripcion }} </option>
                                            @endforeach
                                        </select>
                            ...
                            <div class="row">
                                <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 mb-2">
                                    ...
                                    <select name="bien_servicio" id="bien_servicio" class="form-select form-control">
                                        <option value="selected" selected disabled>[SELECCIONE BIEN, NORMA O SERVICIO]
                                        </option>
                        ...
                        <fieldset>
                            ...
                            <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 mb-2">
                                <div class="mb-2">
                                    <label for="unidades_responsables" class="col-form-label">Seleccione Unidad
                                        responsable de meta</label>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-outline-danger btn-sm" data-bs-dismiss="modal"
                        onclick="cerrarModalf4()">Cerrar</button>
                    <button type="button" class="btn btn-outline-primary btn-sm" id="btn_guardarF4"
    ...
    {{-- MODAL EDITAR --}}
    <div class="modal slide" id="editar_formulario4" data-bs-backdrop="static" data-bs-keyboard="false"
        aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog modal-xl  modal-dialog-scrollable">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    <form id="form_formulario4_editado" method="POST" autocomplete="off">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12 col-md-12 col-lg-6 col-xl-6 py-2">
                                <fieldset>
                                    <legend>INDICADOR DEL FORMULARIO Nº 2</legend>
                                    <div class="mb-2">
                                        <label for="indicador_formulario2_" class="col-form-label">Seleccione Indicador
                                            del formulario nº 2</label>
                                        <select name="indicador_formulario2_" id="indicador_formulario2_"
                        ...
                        <fieldset>
                            ...
                            <div class="row">
                                <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 mb-2">
                                    <label for="bien_servicio_" class="col-form-label">Seleccione Bien, Norma o
                                        Servicio</label>
                        ...
                        <fieldset>
                            ...
                            <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 mb-2">
                                <div class="mb-2">
                                    <label for="unidades_responsable_" class="col-form-label">Seleccione Unidad
                                        responsable de meta</label>
                                    <select name="unidades_responsable_" id="unidades_responsable_"
                                        class="select2_segundo">
                                        <option value="selected" selected disabled>[SELECCIONE UNIDAD RESPONSABLE]</option>
                                        @foreach ($unidades as $lis)
                                            <option value="{{ $lis->id }}">{{ $lis->nombre_completo }}</option>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-outline-primary btn-sm" id="btn_guardarF4editar"> <i
    ...
    <div class="modal slide" id="Modal_asignarEjecucion_presupuestaria" data-bs-backdrop="static"
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"
                        onclick="cerrar_modal_asignacion_form4()"></button>
                </div>
                <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="col-sm-12 col-md-12 col-lg-8 col-xl-8">
                                <div class="mb-3">
                                    ...
                                    <select name="tipo_financiamiento" id="tipo_financiamiento"
                                        class="form-select select2_tercero"
                                        onchange="tipo_financiamientoTengo(this.value)">
                        ...
                        <div class="row text-center d-flex justify-content-center align-items-center">
                            <div class="col-sm-12 col-md-12 col-lg-4 col-xl-4">
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="monto_asignar" id="monto_asignar"
                                            class="form-control monto_number" onkeyup="validar_montos(this.value)"
                                            disabled>
                            ...
                            <div class="col-sm-12 col-md-12 col-lg-4 col-xl-4">
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        <span class="input-group-text" id="basic-addon1">Bs</span>
                                        <input type="text" class="form-control" id="monto_sobrante_ver"
                                            name="monto_sobrante_ver" readonly disabled>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-12 col-md-12 col-lg-4 col-xl-4">
                                <div class="mb-3">
                                    <button class="btn btn-outline-primary" id="btn_guardarasignacionf4"
        ...
        function validarUnicoform4(id) {
            $.ajax({
                ...
                success: function(data) {
                            ...
                            document.getElementById('vizualizar_detalles').innerHTML = `
                                <div class="col-sm-12 col-md-12 col-lg-4 col-xl-4 py-2" >
                                    <fieldset id="success_fieldset">
                                        <legend id="success_legend">OBJETIVO ESTRATEGICO (PDU)</legend>
                                        <p>` + data.form2_rel.objetivo_estrategico[0].descripcion + `</p>
                                    </fieldset>
                                </div>
                                <div class="col-sm-12 col-md-12 col-lg-4 col-xl-4 py-2" >
                                    <fieldset id="success_fieldset">
                                ...
                                <div class="col-sm-12 col-md-12 col-lg-4 col-xl-4 py-2" >
                                    <fieldset id="success_fieldset">
                                        <legend id="success_legend" >OBJETIVO INSTITUCIONAL (PEI)</legend>
                                        <p>` + data.form2_rel.objetivo_institucional[0].descripcion + `</p>
                                    </fieldset>
                                </div>
                            `;
                        }
                    ...
                    if (data.tipo === 'error') {
                        document.getElementById('_indicador_formulario2').innerHTML = `<p id="error_in" >` +
                            data.mensaje + `</p>`;
                            ...
                            document.getElementById('vizualizar_detalles').innerHTML = `
                                <div class="col-sm-12 col-md-12 col-lg-4 col-xl-4 py-2" >
                                    <fieldset id="error_fieldset">
                                        <legend id="error_legend" >OBJETIVO ESTRATEGICO (PDU)</legend>
                                        <p>` + data.form2_rel.objetivo_estrategico[0].descripcion + `</p>
                                    </fieldset>
                                </div>
                                <div class="col-sm-12 col-md-12 col-lg-4 col-xl-4 py-2" >
                                ...
                                <div class="col-sm-12 col-md-12 col-lg-4 col-xl-4 py-2" >
                                    <fieldset id="error_fieldset">
                                        <legend id="error_legend">OBJETIVO INSTITUCIONAL (PEI)</legend>
                                        <p>` + data.form2_rel.objetivo_institucional[0].descripcion + `</p>
                                    </fieldset>
                                </div>
                            `;
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    if (data.tipo === 'success') {
                        ...
                        $('#unidades_responsable_').val(data.mensaje.unidad_responsable[0].id).trigger(
                            'change.select2');
                ...
                success: function(data) {
                    ...
                    cajar_it.forEach(value => {
                        if (value.financiamiento_tipo.asignacion_monto_formulario4.length === 0) {
                            ...
                            $('#tipo_financiamiento').append('<option value = "' + fin_tipo.id + '">' +
                                '[' + fin_tipo.sigla + ']' + fin_tipo.descripcion + '</option>');
                        }
                    });
                    ...
                    $.ajax({
                        ...
                        success: function(resp) {
                            document.getElementById('listar_asignacion_financiamiento_html')
                                .innerHTML = resp;
                        }
                    });
                }
                    ...
                    $.ajax({
                        ...
                        success: function(data) {
                            if (data.tipo === 'success') {
                                ...
                                document.getElementById('monto_asignar_env__').value = data
                                    .monto_asignacion_nuevo;
                                document.getElementById('monto_asignar_env').value = data
                                    .monto_asignacion_nuevo;
                                document.getElementById('btn_guardarasignacionf4_asignacionEditar').disabled =
                                    false;
                            }
                            if (data.tipo === 'error') {
                                alerta_top(data.tipo, data.mensaje);
