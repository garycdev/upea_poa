...
@section('contenido')
            ...
            <div class="col-lg-6">
                <div class="profile-info d-flex align-items-center">
                    @if (Auth::user()->perfil != null)
                        <img class="w-25 rounded-4" src="{{ asset('perfil/'.Auth::user()->perfil) }}" alt="profile-img" loading="lazy">
                    @else
                        <img class="w-25 rounded-4" src="{{ asset('logos/upea_logo.png') }}" alt="profile-img" loading="lazy">
                    @endif
                    ...
                    <div class="profile-name ms-4">
                        ...
                        <button class="btn btn-outline-primary" data-bs-toggle="modal" data-bs-target="#nuevo_perfil" >Agregar foto de perfil</button>
                    </div>
                </div>
            </div>
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <label>CI</label>
                                        <input type="text" class="form-control" placeholder="CI" name="ci" value="{{ Auth::user()->ci_persona }}" readonly>
                                        <div id="_ci" ></div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <label>Nombres</label>
                                        <input type="text" class="form-control" placeholder="Nombres" name="nombres" value="{{ Auth::user()->nombre }}">
                                        <div id="_nombres" ></div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="Apellidos" name="apellido" value="{{ Auth::user()->apellido }}">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="Numero de celular" name="celular" value="{{ Auth::user()->celular }}">
                                        <div id="_celular" ></div>
                                    </div>
                                </div>

                                <div class="save-update text-center">
                                    <button class="btn btn-outline-primary me-2" id="btn_guardar_perfil">Guardar Perfil</button>
                                </div>
                            </div>
                        </form>
                    </div>
                    ...
                    <div class="edit-profile-content card-box-style">
                        ...
                        <form method="POST" id="form_password" autocomplete="off">
                            ...
                            <div class="row">
                                ...
                                <div class="save-update text-center">
                                    <button class="btn btn-outline-primary me-2" id="guardar_password">Guardar Password</button>
                                </div>
                            </div>
                        </form>
                    </div>
    ...
    <!-- Modal nuevo-->
    <div class="modal zoom" id="nuevo_perfil" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog ">
            <div class="modal-content">
                ...
                <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="mb-3 col-xl-12 col-md-12 col-lg-12 col-sm-12 text-center">
                                @if (Auth::user()->perfil != NULL )
                                    <img class="rounded-pill" src="{{ asset('perfil/'.Auth::user()->perfil) }}" alt="" id="preview" style="max-width: 300px; max-height: 300px;">
                                @else
                                    <img  class="rounded-pill" src="{{ asset('logos/no_img.webp') }}" alt="" id="preview" style="max-width: 300px; max-height: 300px;">
                                @endif

                            </div>
                            <form id="form_perfil_imagen"  method="post" autocomplete="off">
                                <input type="hidden" name="id" value="{{ Auth::user()->id }}">
                                <input type="hidden" class="form-control" name="img_ant" value="{{ Auth::user()->perfil }}">

                                <div class="mb-3 col-xl-12 col-md-12 col-lg-12 col-sm-12">
                                    <label for="nombre" class="form-label">Seleccione una imagen</label>
                                    <input type="file" class="form-control "  name="perfil" onchange="previewImage(event)" accept="image/*" >
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-outline-primary btn-sm" id="btn_guardar_perfil_imagen"> <i class="bx bxs-save" id="icono_rodry" ></i> Guardar Perfil</button>
                </div>
            </div>
        </div>
    </div>
