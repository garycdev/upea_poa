            ...
            $(document).on('keyup change', '#nro, #gestion', function() {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        fut.forEach(element => {
                            const urlDetalle = detalleUrlTemplate.replace(':ELEMENT_ID',
                                element.id_fut);
                            const urlPdf = pdfUrlTemplate.replace(':ELEMENT_ID',
                                element.id_fut);
                            ...
                            tabla.row.add([
                                ...
                                `<a href="${urlDetalle}" class="btn btn-outline-primary"  style="display:inline-block">
                                    <i class="ri-eye-fill"></i>
                                </a>
                                <a href="${urlPdf}" class="btn btn-outline-danger" target="_blank" style="display:${element.estado == 'ejecutado' ? 'inline-block' : 'none'}">
