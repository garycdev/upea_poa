...
@section('contenido')
            ...
            <div class="card-box-style">
                <div class="others-title d-flex align-items-center">
                    ...
                    <div class=" ms-auto position-relative">
                        <button type="button" class="btn btn-outline-primary" data-bs-toggle="modal" data-bs-target="#nueva_matriz_planificacion"  ><i class="bx bxs-add-to-queue"></i> Nuevo Matriz de Planificación</button>
                    </div>
                </div>
                <div class="table-responsive">
                    <table class="table table-responsive  text-center table-bordered table-striped" style="width:100%; font-size: 12px;" >
                        <thead>
                            <tr>
                        ...
                        <tbody class="table-group-divider ">
                            @foreach ($matriz_p as $lis)
                                <tr>
                                    <td>
                                        <button class="btn btn-outline-warning btn-sm" onclick="editar_matriz('{{ $lis->id }}', '{{ $pdes[0]->id }}', '{{ $id_area_estrategica }}', '{{ $gestion->id }}')" ><i class="ri-edit-2-fill"></i></button>
                                    </td>
                                    <td>{{ $lis->codigo }}</td>
    ...
    <div class="modal zoom" id="nueva_matriz_planificacion" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
        ...
        <div class="modal-dialog modal-xl modal-dialog-scrollable">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <button type="button" class="btn-close" data-bs-dismiss="modal"  aria-label="Close"  onclick="cerrar_modal_matriz()"></button>
                </div>
                <div class="modal-body">
                    <form id="form_matriz" method="post" autocomplete="off">
                        <input type="hidden" name="id_area_estrategica" id="id_area_estrategica" value="{{ $areas_estrategicas->id }}">
                        ...
                        <fieldset>
                            ...
                            <div class="row">
                                <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6 mb-2"  >
                                    ...
                                    <select name="politica_institucional_pei" id="politica_institucional_pei" class="select2" onchange="obj_estrategico_sub(this.value)">
                                ...
                                <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6 mb-2" >
                                    ...
                                    <select name="objetivo_estrategico_sub" id="objetivo_estrategico_sub" class="select2" onchange="objetivo_estrategico_inst_pei(this.value)">
                                ...
                                <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 mb-2"  >
                                    ...
                                    <select name="indicador_estrategico" id="indicador_estrategico" class="select2">
                                        ...
                                        @foreach ($indicador as $lis)
                                            <option value="{{ $lis->id }}">  [{{ $lis->codigo }}] {{ $lis->descripcion }}</option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="row text-center d-flex justify-content-center align-items-center">
                                    <div class="col-sm-12 col-md-3 col-lg-3 col-xl-3 mb-2">
                                        <div class="mb-2">
                                            ...
                                            <input type="text" class="form-control" id="codigo_resultado_producto" name="codigo_resultado_producto"
                                                placeholder="Ingrese código" maxlength="4"
                                                onkeypress="return soloNumeros(event)">
                                    ...
                                    <div class="col-sm-12 col-md-9 col-lg-9 col-xl-9 mb-2">
                                        <div class="mb-2">
                                            <label for="descripcion_resultado_producto" class="form-label">Descripción</label>
                                            <textarea class="form-control" name="descripcion_resultado_producto" id="descripcion_resultado_producto" rows="3" placeholder="Descripción resultado o producto"></textarea>
                        ...
                        <fieldset>
                            ...
                            <div class="row text-center">
                                <div class="col-sm-12 col-md-3 col-lg-3 col-xl-3 mb-2">
                                    <div class="mb-2">
                                        <label for="linea_base" class="form-label">Linea Base {{ $gestiones[0]->gestion-1 }}</label>
                                ...
                                <div class="col-sm-12 col-md-3 col-lg-3 col-xl-3 mb-2">
                                    <div class="mb-2">
                                        <label for="gestion_1" class="form-label">Gestión: {{ $gestiones[0]->gestion }}</label>
                                ...
                                <div class="col-sm-12 col-md-3 col-lg-3 col-xl-3 mb-2">
                                    <div class="mb-2">
                                        <label for="gestion_2" class="form-label">Gestión: {{ $gestiones[1]->gestion }}</label>
                                ...
                                <div class="col-sm-12 col-md-3 col-lg-3 col-xl-3 mb-2">
                                    <div class="mb-2">
                                        <label for="gestion_3" class="form-label">Gestión: {{ $gestiones[2]->gestion }}</label>
                                ...
                                <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4 mb-2">
                                    <div class="mb-2">
                                        <label for="gestion_4" class="form-label">Gestión: {{ $gestiones[3]->gestion }}</label>
                                ...
                                <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4 mb-2">
                                    <div class="mb-2">
                                        <label for="gestion_5" class="form-label">Gestión: {{ $gestiones[4]->gestion }}</label>
                                ...
                                <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4 mb-2">
                                    <div class="mb-2">
                                        ...
                                        <input type="text" class="form-control" id="meta_mediano_plazo" name="meta_mediano_plazo"
                                            placeholder="Descripción" maxlength="4">
                        ...
                        <fieldset>
                            ...
                            <div class="row text-center d-flex justify-content-center align-items-center">
                                <div class="col-sm-12 col-md-5 col-lg-5 col-xl-5 mb-2"  >
                                    <label for="programa_accion_estrategica" class="col-form-label">Seleccione tipo</label>
                                    <select name="programa_accion_estrategica" id="programa_accion_estrategica" class="form-select form-control">
                                        <option value="selected" selected disabled>[SELECCIONE TIPO]</option>
                                ...
                                <div class="col-sm-12 col-md-7 col-lg-7 col-xl-7 mb-2">
                                    <div class="mb-2">
                                        <label for="descripcion_progrma_accion_estrategica" class="form-label">Descripción</label>
                                        <textarea class="form-control" name="descripcion_progrma_accion_estrategica" id="descripcion_progrma_accion_estrategica" rows="3" placeholder="Descripción programa, proyecto acción estratégica"></textarea>
                            ...
                            <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6 mb-2" >
                                <fieldset>
                                    <legend>UNIDADES INVOLUCRADAS</legend>
                                        <div class="mb-2">
                                            <label for="unidades_involucradas" class="col-form-label">Seleccione Unidades involucradas</label>
                                            <select name="unidades_involucradas[]" id="unidades_involucradas" class="select2" multiple="multiple">
                            ...
                            <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6 mb-2" >
                                <fieldset>
                                    <legend>UNIDADES RESPONSABLES DE META</legend>
                                        <div class="mb-2">
                                            <label for="unidades_responsables" class="col-form-label">Seleccione Unidades responsables de meta</label>
                                            <select name="unidades_responsables[]" id="unidades_responsables" class="select2" multiple="multiple">
                                                @foreach ($unidades as $lis)
                                                    <option value="{{ $lis->id }}">{{ $lis->nombre_completo }}</option>
                                                @endforeach
                                            </select>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-outline-danger btn-sm" data-bs-dismiss="modal" onclick="cerrar_modal_matriz()">Cerrar</button>
                    <button type="button" class="btn btn-outline-primary btn-sm" id="btn_guardar_matriz"> <i class="bx bxs-save" id="icono_rodry"></i> Guardar Matriz de Planificacion</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="modal zoom" id="editar_matriz_planificacion" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
        aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog modal-xl modal-dialog-scrollable">
            <div class="modal-content">
                <div class="modal-header">
                    <h3 class="modal-title fs-5">EDITAR MATRIZ DE PLANIFICACIÓN</h3>
                    <button type="button" class="btn-close" data-bs-dismiss="modal"  aria-label="Close" onclick="reset_editar()"></button>
                </div>
                <div class="modal-body">
                    <div id="mensaje" ></div>
                    <form id="form_matriz_eitar" method="post" autocomplete="off">
                        ...
                        <div class="row">
                            <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6 mb-2" >
                                <fieldset>
                                    <legend>CODIGO</legend>
                                        <div class="mb-2">
                                            <label for="codigo_matriz_e" class="col-form-label">Ingrese código de matriz</label>
                                            <input type="text" class="form-control" id="codigo_matriz_e" name="codigo_matriz_e" placeholder="Ingrese código" maxlength="4" onkeypress="return soloNumeros(event)">
                        ...
                        <fieldset>
                            ...
                            <div class="row">
                                <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6 mb-2"  >
                                    <label for="politica_desarrollo_pdu_e" class="col-form-label">Seleccione Politica de Desarrollo</label>
                                    <select name="politica_desarrollo_pdu_e" id="politica_desarrollo_pdu_e" class="select2_segundo">
                                        <option value="selected" selected disabled>[SELECCIONE LA POLITICA DE DESARROLLO]</option>
                                        @foreach ($politica_desarrollo as $lis)
                                            <option value="{{ $lis->id }}">{{ $lis->descripcion }}</option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6 mb-2"  >
                                    <label for="objetivo_estrategico_pdu_e" class="col-form-label">Seleccione Objetivo Estratégico</label>
                                    <div id="cambiar_obj">
                                        <select name="objetivo_estrategico_pdu_e" id="objetivo_estrategico_pdu_e" class="select2_segundo">
                                            <option value="selected" selected disabled>[SELECCIONE EL OBJETIVO ESTRATÉGICO]</option>
                                        </select>
                                    </div>
                        ...
                        <fieldset>
                            ...
                            <div class="row">
                                <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6 mb-2"  >
                                    <label for="politica_institucional_pei_e" class="col-form-label">Seleccione Politica Institucional</label>
                                    <select name="politica_institucional_pei_e" id="politica_institucional_pei_e" class="select2_segundo">
                                        <option value="selected" selected disabled>[SELECCIONE LA POLITICA INSTITUCIONAL]</option>
                                        @foreach ($politica_institucional as $lis)
                                            <option value="{{ $lis->id }}">{{ $lis->descripcion }}</option>
                                        @endforeach
                                ...
                                <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6 mb-2" >
                                    <label for="objetivo_estrategico_sub_e" class="col-form-label">Seleccione Objetivo Estratégico (SUB)</label>
                                    <select name="objetivo_estrategico_sub_e" id="objetivo_estrategico_sub_e" class="select2_segundo" >
                                        <option value="selected" selected disabled>[OBJETIVO ESTRATÉGICO DEL SISTEMA DE UNIVERSIDADES DE BOLIVIA ]</option>
                                    </select>
                                ...
                                <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6 mb-2" >
                                    <label for="objetivo_estrategico_institucional_e" class="col-form-label">Seleccione Objetivo Estratégico Institucional</label>
                                    <select name="objetivo_estrategico_institucional_e" id="objetivo_estrategico_institucional_e" class="select2_segundo">
                                        <option value="selected" selected disabled>[OBJETIVO ESTRATÉGICO INSTITUCIONAL]</option>
                                    </select>
                        ...
                        <fieldset>
                            ...
                            <div class="row">
                                <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 mb-2"  >
                                    <label for="indicador_estrategico_e" class="col-form-label">Seleccione Indicador Estratégico</label>
                                    <select name="indicador_estrategico_e" id="indicador_estrategico_e" class="select2_segundo">
                                        <option value="selected" selected disabled>[SELECCIONE EL INDICADOR ESTRATÉGICO]</option>
                                    </select>
                        ...
                        <fieldset>
                            ...
                            <div class="row">
                                ...
                                <div class="row text-center d-flex justify-content-center align-items-center">
                                    <input type="hidden" name="edi_id_resultado_producto" id="edi_id_resultado_producto">
                                    <div class="col-sm-12 col-md-3 col-lg-3 col-xl-3 mb-2">
                                        <div class="mb-2">
                                            <label for="codigo_resultado_producto_e" class="form-label">Código</label>
                                            <input type="text" class="form-control" id="codigo_resultado_producto_e" name="codigo_resultado_producto_e"
                                                placeholder="Ingrese código" maxlength="4"
                                                onkeypress="return soloNumeros(event)">
                                    ...
                                    <div class="col-sm-12 col-md-9 col-lg-9 col-xl-9 mb-2">
                                        <div class="mb-2">
                                            <label for="descripcion_resultado_producto_e" class="form-label">Descripción</label>
                                            <textarea class="form-control" name="descripcion_resultado_producto_e" id="descripcion_resultado_producto_e" rows="3" placeholder="Descripción resultado o producto"></textarea>
                        ...
                        <fieldset>
                            ...
                            <div class="row text-center">
                                <div class="col-sm-12 col-md-3 col-lg-3 col-xl-3 mb-2">
                                    <div class="mb-2">
                                        <label for="linea_base_e" class="form-label">Linea Base {{ $gestiones[0]->gestion-1 }}</label>
                                ...
                                <div class="col-sm-12 col-md-3 col-lg-3 col-xl-3 mb-2">
                                    <div class="mb-2">
                                        <label for="gestion_1_e" class="form-label">Gestión: {{ $gestiones[0]->gestion }}</label>
                                ...
                                <div class="col-sm-12 col-md-3 col-lg-3 col-xl-3 mb-2">
                                    <div class="mb-2">
                                        <label for="gestion_2_e" class="form-label">Gestión: {{ $gestiones[1]->gestion }}</label>
                                ...
                                <div class="col-sm-12 col-md-3 col-lg-3 col-xl-3 mb-2">
                                    <div class="mb-2">
                                        <label for="gestion_3_e" class="form-label">Gestión: {{ $gestiones[2]->gestion }}</label>
                                ...
                                <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4 mb-2">
                                    <div class="mb-2">
                                        <label for="gestion_4_e" class="form-label">Gestión: {{ $gestiones[3]->gestion }}</label>
                                ...
                                <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4 mb-2">
                                    <div class="mb-2">
                                        ...
                                        <input type="text" class="form-control" id="meta_mediano_plazo_e" name="meta_mediano_plazo_e"
                                            placeholder="Descripción" maxlength="4">
                        ...
                        <fieldset>
                            <legend>PROGRAMA - PROYECTO - ACCIÓN ESTRATÉGICA</legend>
                            <div class="row text-center d-flex justify-content-center align-items-center">
                                <input type="hidden" name="edi_inv_programa_proyecto_accion_estrategica" id="edi_inv_programa_proyecto_accion_estrategica" >
                                <div class="col-sm-12 col-md-5 col-lg-5 col-xl-5 mb-2"  >
                                    <label for="programa_accion_estrategica_e" class="col-form-label">Seleccione tipo</label>
                                    <select name="programa_accion_estrategica_e" id="programa_accion_estrategica_e" class="form-select form-control">
                                        <option value="selected" selected disabled>[SELECCIONE TIPO]</option>
                                        @foreach ($porgrama_proy_acc as $lis)
                                            <option value="{{ $lis->id }}"> {{ $lis->nombre }}</option>
                                        @endforeach
                                ...
                                <div class="col-sm-12 col-md-7 col-lg-7 col-xl-7 mb-2">
                                    <div class="mb-2">
                                        <label for="descripcion_progrma_accion_estrategica_e" class="form-label">Descripción</label>
                                        <textarea class="form-control" name="descripcion_progrma_accion_estrategica_e" id="descripcion_progrma_accion_estrategica_e" rows="3" placeholder="Descripción programa, proyecto acción estratégica"></textarea>
                        ...
                        <div class="row">
                            <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6 mb-2" >
                                <fieldset>
                                    <legend>UNIDADES INVOLUCRADAS</legend>
                                        <div class="mb-2">
                                            <label for="unidades_involucradas_e" class="col-form-label">Seleccione Unidades involucradas</label>
                                            <select name="unidades_involucradas_e[]" id="unidades_involucradas_e" class="select2_segundo valores_inv" multiple="multiple">
                                                @foreach ($unidades as $lis)
                                                    <option value="{{ $lis->id }}">{{ $lis->nombre_completo }}</option>
                                                @endforeach
                                            </select>
                            ...
                            <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6 mb-2" >
                                <fieldset>
                                    <legend>UNIDADES RESPONSABLES DE META</legend>
                                        <div class="mb-2">
                                            <label for="unidades_responsables_e" class="col-form-label">Seleccione Unidades responsables de meta</label>
                                            <select name="unidades_responsables_e[]" id="unidades_responsables_e" class="select2_segundo" multiple="multiple">
                                                @foreach ($unidades as $lis)
                                                    <option value="{{ $lis->id }}">{{ $lis->nombre_completo }}</option>
                                                @endforeach
                                            </select>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-outline-danger btn-sm" data-bs-dismiss="modal" onclick="reset_editar()">Cerrar</button>
                    <button type="button" class="btn btn-outline-primary btn-sm" id="btn_guardar_matriz_editado"> <i class="bx bxs-save" id="icono_rodry"></i> Guardar Matriz de Planificacion</button>
                </div>
            </div>
        </div>
    </div>
...
@section('scripts')
    <script>
        ...
        function obj_estrategico_pdu(id){
            $.ajax({
                type: "POST",
        ...
        function obj_estrategico_sub(id){
            $.ajax({
                type: "POST",
        ...
        function editar_matriz(id, id_pdes, id_area_est, id_ges){
            $.ajax({
                ...
                data: {id:id, id_pdes:id_pdes, id_area_est:id_area_est, id_ges:id_ges},
                dataType: "JSON",
                async: false,
                success: function (data) {
                    if(data.tipo==='success'){
                        ...
                        $('#politica_desarrollo_pdu_e').val(data.mensaje.matriz_e.politica_desarrollo_pdu[0].id).trigger('change');
                        data.mensaje.objetivo_estrategico_e.forEach(value => {
                            $('#objetivo_estrategico_pdu_e').append('<option value = "' + value.id + '">' + value.descripcion + '</option>');
                        });
                        $('#objetivo_estrategico_pdu_e').val(data.mensaje.matriz_e.objetivo_estrategico[0].id).trigger('change');
                        //PARA LA PARTE DE PEI SUB
                        $('#politica_institucional_pei_e').val(data.mensaje.matriz_e.politica_desarrollo_pei[0].id).trigger('change');

                        data.mensaje.objetivo_estrategico_sub_e.forEach(value => {
                            $('#objetivo_estrategico_sub_e').append('<option value = "' + value.id + '">' + value.descripcion + '</option>');
                        });
                        $('#objetivo_estrategico_sub_e').val(data.mensaje.matriz_e.objetivo_estrategico_sub[0].id).trigger('change');
                        //PARA LA PARTE DE PEI INSTITUCIONAL
                        data.mensaje.objetivo_institucional_e.forEach(value => {
                            $('#objetivo_estrategico_institucional_e').append('<option value = "' + value.id + '">' + value.descripcion + '</option>');
                        });
                        ...
                        data.mensaje.indicador_e.forEach(value => {
                            $('#indicador_estrategico_e').append('<option value = "' + value.id + '">' + '['+value.codigo+']'+value.descripcion + '</option>');
                        });
                        $('#indicador_estrategico_e').val(data.mensaje.matriz_e.indicador_pei.id).trigger('change');
                        ...
                        document.getElementById('edi_id_resultado_producto').value = data.mensaje.matriz_e.resultado_producto.id;
                        document.getElementById('codigo_resultado_producto_e').value = data.mensaje.matriz_e.resultado_producto.codigo;
                        document.getElementById('descripcion_resultado_producto_e').value = data.mensaje.matriz_e.resultado_producto.descripcion;
                        ...
                        document.getElementById('meta_mediano_plazo_e').value = data.mensaje.matriz_e.meta_mediano_plazo;
                        //PROGRAMA PROYECTO-ACCION ESTRATEGICA
                        document.getElementById('edi_inv_programa_proyecto_accion_estrategica').value = data.mensaje.matriz_e.programa_proyecto_accion.id;
                        document.getElementById('programa_accion_estrategica_e').value = data.mensaje.matriz_e.programa_proyecto_accion.id_tipo_prog_acc;
                        document.getElementById('descripcion_progrma_accion_estrategica_e').value = data.mensaje.matriz_e.programa_proyecto_accion.descripcion;
        ...
        function reset_editar(){
            $('#objetivo_estrategico_pdu_e').empty().append(
                '<option selected disabled>[SELECCIONE EL OBobjetivo_estrategico_institucional_eJETIVO ESTRATÉGICO]</option>'
            );
