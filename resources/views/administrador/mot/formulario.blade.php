    ...
    <div class="page">
        <div class="main-content app-content">
            <div class="container-fluid">
                ...
                <form class="row" method="POST" action="{{ route('postModificacion', 0) }}" id="formularioMot">
                    @csrf
                    <div class="card">
                        ...
                        <input type="hidden" name="id_conformulado" id="id_conformulado" value="{{ $id_conformulado }}">
                    </div>
                    {{-- @dd($areas_formulado) --}}
                    <div class="card">
                        <div class="card-body">
                            <div id="modificaciones">
                                <div class="modificacion row mb-3">
                                    ...
                                    <div class="col-2 d-flex align-items-center">
                                        ...
                                        <input type="text" class="form-control" name="area1" id="area1" readonly>
                                        <input type="text" class="form-control" name="id_area1" id="id_area1" readonly>
                                    </div>
                                    <div class="col-4">
                                ...
                                <div class="modificacion row mb-3">
                                    ...
                                    <div class="col-2 d-flex align-items-center">
                                        ...
                                        <input type="text" class="form-control" id="id_area2" name="id_area2" readonly>
                                    </div>
                                    <div class="col-4">
                                ...
                                <div class="modificacion row mb-3">
                                    ...
                                    <div class="col-4">
                                        ...
                                        <input type="hidden" id="og_de_id" name="og_de_id">
                                    </div>
                                    <div class="col-3 d-flex align-items-center">
                                        <label for="">IMPORTE:&nbsp; </label>
                                        <input type="number" step="0.01" min="0.00" placeholder="0.00"
                                ...
                                <div class="modificacion row mb-3">
                                    ...
                                    <div class="col-4">
                                        ...
                                        <input type="hidden" id="og_a_id" name="og_a_id">
                                    </div>
                                    <div class="col-3 d-flex align-items-center">
                                        <label for="">IMPORTE:&nbsp; </label>
                                        <input type="number" step="0.01" min="0.00" placeholder="0.00"
                                ...
                                <div class="modificacion row mb-3">
                                    ...
                                    <div class="col-4">
                                        ...
                                        <input type="hidden" name="formulario5_a" id="formulario5_a">
                                    </div>
                                    <div class="col-3 d-flex align-items-center">
                                        <label for="">IMPORTE:&nbsp; </label>
                                        <input type="number" step="0.01" min="0.00" placeholder="0.00"
                            ...
                            <div id="de-a">
                                <div class="item">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-3 d-flex align-items-center">
                                            <b>Monto habilitado (Bs) :</b>
                                        </div>
                                        <div class="col-3">
                                            <input type="text" class="form-control w-50" name="monto_habilitado"
                                                id="monto_habilitado" value="0" readonly>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-center mt-4">
                                <a href="{{ route('listarFormularios', $id_conformulado) }}"
...
@section('scripts')
    <script>
        $(document).ready(function() {
            $('#formularioMot').submit(function(e) {
                e.preventDefault();
                ...
                if (monto_habilitado <= 0) {
                    $('#monto_habilitado_error').text(
                        'Debe habilitar un monto para modificación.'
                    );
                    return;
                } else {
                    $('#monto_habilitado_error').text('');
        ...
        function cambiarAreaEstrategica(select) {
            if (select.value == 0) {
                ...
                $('#id_area1').val(select.options[select.selectedIndex].getAttribute('data-id'))
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        response.forEach(element => {
                            $('#select-objetivoGestion').append(
                                `<option value="${element.codigo}" data-id="${element.id}" data-value="${element.f2_id}" data-value-id="${element.id}">[${element.codigo}] ${element.descripcion}</option>`
                            )
                        })
        ...
        function cambiarAreaEstrategica2(select) {
            if (select.value == 0) {
                ...
                $('#id_area2').val(select.options[select.selectedIndex].getAttribute('data-id'))
        ...
        function cambiarObjetivoGestion2(select) {
            if (select.value == 0) {
                ...
                const id = $('#select-objetivoGestion2 option:selected').attr('data-id');
                $('#og_a_id').val(id);
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-2 fw-bold">
                                            ...
                                            <div class="form-check form-switch mb-0">
                                                <label class="form-check-label" for="fuente_${element.tipo_financiamiento_id}">Habilitar</label>
        ...
        function cambiarTareaProyecto2(select) {
            if (select.value == 0) {
                ...
                const id = $('#select-tareaProyecto2 option:selected').attr('data-value');
                $('#formulario5_a').val(id)
            }
        }
