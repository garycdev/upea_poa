...
@section('contenido')
    ...
    <div class="card-box-style">
        ...
        <ul class="nav nav-tabs nav-fill mb-4" id="myTab" role="tablist">
            <li class="nav-item" role="presentation">
                <button class="nav-link link-secondary active" id="home-tab" data-bs-toggle="tab" data-bs-target="#home-tab-pane" type="button" role="tab" aria-controls="home-tab-pane" aria-selected="true">USUARIOS ACTIVOS</button>
            </li>
            <li class="nav-item" role="presentation">
                <button class="nav-link link-secondary" id="profile-tab" data-bs-toggle="tab" data-bs-target="#profile-tab-pane" type="button" role="tab" aria-controls="profile-tab-pane" aria-selected="false">USUARIOS INACTIVOS</button>
            </li>
        </ul>
            ...
            <div class="tab-pane fade show active" id="home-tab-pane" role="tabpanel" aria-labelledby="home-tab" tabindex="0">
                ...
                <div class="others-title d-flex align-items-center">
                    <div class=" ms-auto position-relative">
                        <button type="button" class="btn btn-outline-primary" data-bs-toggle="modal" data-bs-target="#nuevo_usuario" > <i class="bx bxs-add-to-queue" ></i> Nuevo Usuario</button>
                    </div>
                </div>
                                    ...
                                    <td>
                                        <div class="form-check form-switch ">
                                            @if ($lis->estado=='activo')
                                                <input class="form-check-input" type="checkbox" onclick="estado_usuario('{{ $lis->id }}')" checked="checked"/>
                                            @else
                                                <input class="form-check-input " type="checkbox" onclick="estado_usuario('{{ $lis->id }}')" />
                                            @endif
                                        </div>
                                    </td>
                                    <td>
                                        <button class="btn btn-outline-primary btn-sm" onclick="reset_usuario('{{ $lis->id }}')"><i class="ri-lock-unlock-line"></i></button>
                                        <button class="btn btn-outline-warning btn-sm" onclick="editar_usuario_e('{{ $lis->id }}')"><i class="ri-edit-2-fill"></i></button>
                                        <button class="btn btn-outline-danger btn-sm" onclick="eliminar_usuario('{{ $lis->id }}')"><i class="ri-delete-bin-7-fill" ></i></button>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
    ...
    <!-- Modal nuevo-->
    <div class="modal zoom" id="nuevo_usuario" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                    ...
                    <form id="form_usuario"  method="post" autocomplete="off">
                        <div class="row">
                            <div class="mb-3 col-xl-6 col-md-6 col-lg-6 col-sm-12">
                                ...
                                <input type="text" class="form-control" id="ci" name="ci" placeholder="Ingrese ci" onkeyup="validar_us(this.value)" maxlength="10">
                                <div id="_ci" ></div>
                            </div>
                            <div class="mb-3 col-xl-6 col-md-6 col-lg-6 col-sm-12">
                                <label for="nombre" class="form-label">Nombre</label>
                                <input type="text" class="form-control" id="nombre" name="nombre" placeholder="Ingrese un nombre" disabled>
                                <div id="_nombre" ></div>
                            </div>
                            <div class="mb-3 col-xl-6 col-md-6 col-lg-6 col-sm-12">
                                <label for="apellido" class="form-label">Apellido</label>
                                <input type="text" class="form-control" id="apellido" name="apellido" placeholder="Ingrese un apellido" disabled>
                                <div id="_apellido" ></div>
                            </div>
                            <div class="mb-3 col-xl-6 col-md-6 col-lg-6 col-sm-12">
                                <label for="email" class="form-label">Email</label>
                                <input type="email" class="form-control" id="email" name="email" placeholder="Ingrese un email" disabled>
                                <div id="_email" ></div>
                            </div>
                            ...
                            <div class="mb-3 col-xl-12 col-md-12 col-lg-12 col-sm-12">
                                ...
                                <select name="rol" id="rol" class="form-select" onchange="verificar_roles(this.value)">
                            ...
                            <div class="mb-3 col-xl-12 col-md-12 col-lg-12 col-sm-12">
                                ...
                                <select name="tipo" id="tipo" class="select2" onchange="listar_cua(this.value)" disabled >
                            ...
                            <div class="mb-3 col-xl-6 col-md-6 col-lg-6 col-sm-12">
                                ...
                                <input type="text" class="form-control" id="usuario" name="usuario" placeholder="Ingrese un usuario" disabled>
                                <div id="_usuario" ></div>
                            </div>
                            <div class="mb-3 col-xl-6 col-md-6 col-lg-6 col-sm-12">
                                <label for="password" class="form-label">Password</label>
                                <input type="text" class="form-control" id="password" name="password" placeholder="Ingrese un password" disabled>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-outline-primary btn-sm" id="btn_guardar_usuario" disabled> <i class="bx bxs-save" id="icono_rodry" ></i> Guardar Usuario</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <!-- Modal reset-->
    <div class="modal zoom" id="Modal_usuario_reset" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h3 class="modal-title fs-5">Reset Usuario</h3>

                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close" onclick="vaciar_campo_reset()" ></button>
                </div>
                <div class="modal-body">
                    <form id="form_usuario_reset"  method="post" autocomplete="off">
                        ...
                        <div class="row">
                            ...
                            <div class="mb-3 col-xl-6 col-md-6 col-lg-6 col-sm-12">
                                ...
                                <input type="text" class="form-control" id="usuario_r" name="usuario_r" placeholder="Ingrese usuario"  maxlength="15">
                                <div id="_usuario_r" ></div>
                            </div>
                            <div class="mb-3 col-xl-6 col-md-6 col-lg-6 col-sm-12">
                                <label for="nombre" class="form-label">Password</label>
                                <input type="text" class="form-control" id="password_r" name="password_r" placeholder="Ingrese password">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-outline-danger btn-sm" data-bs-dismiss="modal" onclick="vaciar_campo_reset()">Cerrar</button>
                    <button type="button" class="btn btn-outline-primary btn-sm" id="btn_guardar_usuario_reset"> <i class="bx bxs-save" id="icono_rodry" ></i> Guardar Usuario y contraseña</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <!-- Modal nuevo-->
    <div class="modal zoom" id="editar_usuario" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    <form id="form_usuario_editar"  method="post" autocomplete="off">
                        ...
                        <div class="row">
                            <div class="mb-3 col-xl-6 col-md-6 col-lg-6 col-sm-12">
                                <label for="ci" class="form-label">CI</label>
                                <input type="text" class="form-control" id="ci_e" name="ci_e" placeholder="Ingrese ci" maxlength="10" readonly >
                                <div id="_ci_e" ></div>
                            </div>
                            <div class="mb-3 col-xl-6 col-md-6 col-lg-6 col-sm-12">
                                <label for="nombre" class="form-label">Nombre</label>
                                <input type="text" class="form-control" id="nombre_e" name="nombre_e" placeholder="Ingrese un nombre" >
                                <div id="_nombre_e" ></div>
                            </div>
                            <div class="mb-3 col-xl-6 col-md-6 col-lg-6 col-sm-12">
                                <label for="apellido" class="form-label">Apellido</label>
                                <input type="text" class="form-control" id="apellido_e" name="apellido_e" placeholder="Ingrese un apellido" >
                                <div id="_apellido_e" ></div>
                            </div>
                            <div class="mb-3 col-xl-6 col-md-6 col-lg-6 col-sm-12">
                                <label for="email" class="form-label">Email</label>
                                <input type="email" class="form-control" id="email_e" name="email_e" placeholder="Ingrese un email" >
                                <div id="_email_e" ></div>
                            </div>
                            <div class="mb-3 col-xl-12 col-md-12 col-lg-12 col-sm-12">
                            ...
                            <div class="mb-3 col-xl-12 col-md-12 col-lg-12 col-sm-12">
                                <label for="tipo" class="form-label">Seleccione Tipo</label>
                                <select name="tipo_" id="tipo_" class="select2_segundo" disabled >
                                    <option value="selected" selected disabled>[SELECCIONE TIPO]</option>
                                </select>
                            </div>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-outline-danger btn-sm" data-bs-dismiss="modal">Cerrar</button>
                    <button type="button" class="btn btn-outline-primary btn-sm" id="btn_guardar_usuario_edi"> <i class="bx bxs-save" id="icono_rodry" ></i> Guardar Usuario</button>
                </div>
            </div>
        </div>
    </div>
            ...
            if(ci.length > 4){
                $.ajax({
                    ...
                    success: function (data) {
                        if(data.tipo==='error'){
                            bloquear();
                            document.getElementById('_ci').innerHTML = '<p style="color:red" >'+data.mensaje+'</p>';
                        }
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if(data.tipo==='success'){
                        ...
                        datos.forEach(value => {
                            $('#tipo').append('<option value = "' + value.id + '">' + value.nombre + '</option>');
                        });
                    }
                }
            });
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if(data.tipo==='success'){
                        ...
                        let datos = data.mensaje;
                        datos.forEach(value => {
                            $('#carrera').append('<option value = "' + value.id + '">' + value.nombre_completo + '</option>');
                        });
                    }
                    if(data.tipo==='error'){
                        lista_cua.disabled = true;
            ...
            $.ajax({
                ...
                success: function (data) {
                    if(data.tipo==='success'){
                        ...
                        document.getElementById('alerta').innerHTML = `<div class="alert alert-primary" role="alert">Usuario : <a href="#" class="alert-link">`+data.mensaje.nombre+' '+data.mensaje.apellido+`</a></div>`;
                ...
                success: function (data) {
                    ...
                    if(data.carreras != null){
                        ...
                        data.tipo_cua_.forEach(value => {
                            $('#tipo_').append('<option value = "' + value.id + '">' + value.nombre + '</option>');
                        });
                        ...
                        data.lis_carrera.forEach(value => {
                            $('#carrera_').append('<option value = "' + value.id + '">' + value.nombre_completo + '</option>');
                        });
