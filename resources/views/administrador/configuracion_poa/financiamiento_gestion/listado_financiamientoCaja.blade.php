    ...
    <tbody>
        ...
        @foreach ($caja_asignadaFinanciada as $lis)
            ...
            <tr>
                ...
                <td>
                    <a class="btn btn-outline-danger btn-sm" href="{{ asset('documento_privado/'.$lis->documento_privado) }}" target="_blank"><i class="ri-file-pdf-line"></i></a>
                </td>
                <td>
                    <button class="btn btn-outline-warning btn-sm" onclick="editar_financiamientoTipo('{{ $lis->id }}')" ><i class="ri-edit-2-fill"></i></button>
                </td>
            </tr>
        @endforeach
