...
@section('contenido')
        ...
        <div class="container-fluid">
            <div class="card-box-style ">
                    ...
                    <div class="row text-center">
                        ...
                        <div class="mb-3 col-sm-12 col-md-6 col-lg-4 col-xl-4">
                            <fieldset>
                                ...
                                <select name="gestion_especifica" id="gestion_especifica" class="form-select"
                                    onchange="verificar_formPartida(this.value)">
                        ...
                        <div class="mb-3 col-sm-12 col-md-6 col-lg-4 col-xl-4">
                            <fieldset>
                                ...
                                <select name="tipo_partida" id="tipo_partida" class="form-select"
                                    onchange="mostrar_clasificadores(this.value)">
                        ...
                        <div class="mb-3 col-sm-12 col-md-6 col-lg-6 col-xl-4">
                            <fieldset>
                                ...
                                <input type="text" class="form-control" name="codigo" id="codigo"
                                    placeholder="Ingrese codigo" maxlength="5" onkeypress="return soloNumeros(event)">
                                <div id="_codigo"></div>
                            </fieldset>
                        </div>
                        ...
                        <div class="mb-3 col-sm-12 col-md-6 col-lg-6 col-xl-4">
                            <fieldset>
                                ...
                                <input type="date" name="fecha_inicial" id="fecha_inicial" class="form-control"
                                    onchange="validar_fechaFin(this.value)">
                ...
                <div class="text-center">
                    <button type="button" class="btn btn-outline-primary btn-sm" id="btn_guardar_configuracionFormulado">
                        <i class="bx bxs-save" id="icono_rodry"></i> Guardar configuración del formulado</button>
                </div>
                <div class="row py-4">
    ...
    <!-- Modal  editar foda-->
    <div class="modal zoom" id="editarFormuladoModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"
                        onclick="cerrar_modal_editar()"></button>
                </div>
                <div class="modal-body">
                    <form id="form_config_edi" method="post" autocomplete="off">
                        ...
                        <div class="mb-3 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                            <fieldset>
                                <legend>Ingrese un código</legend>
                                <input type="text" class="form-control" name="codigo_" id="codigo_"
                                    placeholder="Ingrese codigo" maxlength="5" onkeypress="return soloNumeros(event)">
                                <div id="_codigo_"></div>
                            </fieldset>
                        </div>
                        ...
                        <div class="mb-3 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                            <fieldset>
                                <legend>Fecha inicial</legend>
                                <input type="date" name="fecha_inicial_" id="fecha_inicial_" class="form-control"
                                    onchange="validar_fechaAc(this.value)">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-outline-danger btn-sm" data-bs-dismiss="modal"
                        onclick="cerrar_modal_editar()">Cerrar</button>
                    <button type="button" class="btn btn-outline-primary btn-sm" id="btn_guardar_conf_editado"> <i
                            class="bx bxs-save" id="icono_rodry"></i> Guardar Configuración</button>
                </div>
            </div>
        </div>
    </div>
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    partida_datos.forEach(value => {
                        if (!value.configuracion_formulado.length > 0) {
                            $('#tipo_partida').append('<option value = "' + value.id + '">' + value
                                .descripcion + '</option>');
                        }
                    });
                }
