...
@section('scripts')
    ...
    <script>
        ...
        function selectOpcion(sel) {
            ...
            $('#gestion').prop('selectedIndex', 0).trigger('change')
            $('#gestion_esp').prop('selectedIndex', 0).trigger('change')
            $('#periodos').prop('selectedIndex', 0).trigger('change')

            let actual = new Date()
            let anterior = new Date(actual)
            anterior.setMonth(anterior.getMonth() - 1)
            $('#rango').val(`${formatoFecha(anterior)} - ${formatoFecha(actual)}`).trigger('change')
