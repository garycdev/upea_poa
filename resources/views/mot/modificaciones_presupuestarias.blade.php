            ...
            <div class="row align-items-center">
                <div class="col-lg-12 col-sm-12">
                    <div class="page-title">
                        <h5>
                            FORMULARIO DE MODIFICACION POA - PRESUPUESTO DE OBJETIVOS Y/O TAREAS<br>(ACTIVIDADES-OPERACIONES
                            - MOT)
                        </h5>
        ...
        function selectGestion(gestion) {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    // creamos el contenedor como objeto jQuery
                        ...
                        response.forEach(function(element) {
                            let $item = $(`
                                <div class="ag-courses_item">
                                    <a href="{{ route('listarFormularios', ['id_conformulado' => 'ELEMENT_ID']) }}" class="ag-courses-item_link">
                    ...
                    // finalmente agregamos el contenedor al DOM
